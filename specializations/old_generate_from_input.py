...
def generate_themes(profile, specialization, competency):
    ...
    prompt = f"""Ты генеришь темы для тестирования IT-специалистов на конференции в Казахстане (банки/телеком).
...
- Реалистичные для банковской/телеком индустрии в Казахстане
...
def generate_questions(profile, specialization, competency, theme):
    ...
    prompt = f"""Ты генеришь вопросы для тестирования IT-специалистов на конференции в Казахстане (банки/телеком).
